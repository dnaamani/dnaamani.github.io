    ...
    http.onreadystatechange = function () {
        if (http.readyState == 4 && http.status == 200) {
            ...
            messages.forEach(function (m) {
                ...
                li += '<cite>' + m.name + ' </cite> <small>' + m.time + '</small><br>' + m.text +
                    '</span>' +
                    '</div>' +
                    '</li>';
...
var babble = {
    ...
    postMessage: function () {
        ...
        var m = { text: text, email: babble.userInfo.email, name: babble.userInfo.name, pic: babble.userInfo.pic};
...
btnstayAnym.onclick = function () {
    ...
    babble.userInfo.email = 'Anonymous' + Math.random();
